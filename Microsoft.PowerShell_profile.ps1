$githubUser = "dual-a" # Change this here if you forked the repository.
$name= "abdullah.ahmad" # Change this to your name.
...
$OhMyPoshConfigFileName = "wholespace.omp.json" # Filename of the OhMyPosh config file
